import { Component, OnInit, CUSTOM_ELEMENTS_SCHEMA,ViewChild,ElementRef, signal } from '@angular/core';
...
export class UserhomePage implements OnInit {
  ...
  async ionViewDidEnter(){
    //Waits for view to be ready prevents race condition 
  ...
  // destroys map when user moves away from page 
  async ngOnDestroy(){
    if (this.newMap){
